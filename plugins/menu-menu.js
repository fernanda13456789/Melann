...
`.trim()
let buttons = [
{ buttonId: '#donar', buttonText: { displayText: '📮 NO CLICK 📮' }, type: 1 },
//{ buttonId: '#terminosycondiciones', buttonText: { displayText: '📋 CONDICIONES 📋' }, type: 1 }]
{ buttonId: '#infobot', buttonText: { displayText: '🐾 QUE EWS ESTO 🐾' }, type: 1 }]
let buttonMessage = {
image: pp,
caption: str.trim(),
mentions: [m.sender],
...
conn.reply(m.chat, '*[❗𝐈𝐍𝐅𝐎❗]EL MENU TIENE UN ERROR, DAME UN MOMENTO PARA SOLUCIONARLO*', m)
}}
